...
export function Logo({ compact = false }: { compact?: boolean }) {
  return (
    <Link href="/" className="flex items-center gap-3 group">
      <svg width="36" height="36" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden className="text-foreground group-hover:text-accent transition-colors duration-300">
        <rect width="100" height="100" fill="currentColor" rx="16" />
        <path d="M 26 24 L 26 52 C 26 66 34 72 43 72 C 52 72 60 66 60 52 L 60 30"
          fill="none" stroke="#fff" strokeWidth="8.5" strokeLinecap="round" strokeLinejoin="round" />
